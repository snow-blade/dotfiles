# Generated by Powerlevel10k configuration wizard on 2020-06-21 at 00:54 CEST.
...
# right frame, dark-ornaments, compact, many icons, fluent, instant_prompt=verbose.
...
() {
  ...
  function prompt_example() {
    p10k segment -b 1 -f 3 -i '⭐' -t 'hi, %n keep up the good work'
  }
